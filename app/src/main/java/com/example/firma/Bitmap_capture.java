...
public class Bitmap_capture extends View {
    ...
    public Bitmap_capture(Context context, AttributeSet attr) {
        super(context, attr);
        _Path = new Path();
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        _Bitmap = android.graphics.Bitmap.createBitmap(w, (h > 0 ? h : ((View) this.getParent()).getHeight()), android.graphics.Bitmap.Config.ARGB_8888);
    ...
    public android.graphics.Bitmap getBitmap() {
        ...
        android.graphics.Bitmap b = android.graphics.Bitmap.createBitmap(v.getWidth(), v.getHeight(), android.graphics.Bitmap.Config.ARGB_8888);
